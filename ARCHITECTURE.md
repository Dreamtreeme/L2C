...
실제 8개 Wanted 공고 상세 페이지를 대상으로 Classic과 Agent 시스템을 동시에 구동하여 데이터를 수집하고 정합성을 검증한 결과([jd_all_comparison_report.md](file:///c:/Users/psg/Desktop/L2C/data/jd_all_comparison_report.md)):
