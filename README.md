...
Critic 검토 비용은 `$0.0133770`이며 이 표본의 비용 절감 기준 손익분기점은 약
1.50회입니다. OCR timeout과 재생 폴백은 없었습니다. 실행 조건과 원본 집계값은
[`docs/evidence/saramin_target_contract_pair_20260814.json`](./docs/evidence/saramin_target_contract_pair_20260814.json)에
보존했습니다.

이 측정은 한 공고를 대상으로 한 단일 짝 실험입니다. 사이트별 반복 성공률과 신규
사이트 적용 공수는 아직 충분한 표본을 확보하지 못했습니다.
