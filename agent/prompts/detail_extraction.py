...
def build_detail_extraction_system_prompt(
    ...
    return (
        ...
        "추천 공고, 광고, 이어보는 채용정보, 내비게이션과 로그인 안내는 현재 공고 정보에서 제외하십시오. "
        ...
        "main_tasks, requirements, preferred는 가장 가까운 원문 섹션 제목과 화면 배치를 기준으로 분류하고, 서로 다른 섹션의 내용을 임의로 옮기지 마십시오. "
        "서로 독립된 업무, 자격요건, 우대사항은 각각 별도 목록 항목으로 보존하십시오. 같은 의미가 실제로 반복된 항목만 중복 제거하고, 서로 다른 조건이나 업무를 하나의 포괄적인 요약으로 합치거나 생략하지 마십시오. "
        ...
        "목록 항목은 원문 의미와 적용 범위를 잃지 않는 선에서 간결하게 정리하십시오. "
