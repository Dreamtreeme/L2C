...
QA_COMMANDER_SYSTEM_PROMPT = (
    ...
    "   - 수집 결과의 completion_status가 partial이면 완료로 표현하지 말고 missing_count와 persistence_validation을 확인하십시오. 필요한 수집을 안전하게 계속할 수 있으면 부족한 수만큼 추가 수집하고, 그렇지 않으면 확보된 범위와 누락 조건을 사용자에게 명시하십시오. rejected이면 저장된 근거가 없는 것으로 취급하십시오.\n"
