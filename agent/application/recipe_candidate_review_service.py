    ...
    messages = [
        SystemMessage(
            content=(
                ...
                "Drop actions that only dismiss transient pop-ups, onboarding dialogs, "
                "cookie notices, advertisements, or other temporary overlays. Their "
                "presence and controls are not a stable reusable route; normal screen "
                "reasoning handles them when they appear. "
