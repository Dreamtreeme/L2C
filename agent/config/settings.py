...
class BrowserSettings(SectionSettings):
    ...
    vision_window_width: int = Field(1920, ge=640, le=7680, validation_alias="VISION_BROWSER_WINDOW_WIDTH")
    vision_window_height: int = Field(1080, ge=480, le=4320, validation_alias="VISION_BROWSER_WINDOW_HEIGHT")
