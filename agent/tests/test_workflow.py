...
def main():
    ...
    initial_state = {
        "goal": (
            "현재 바탕화면입니다. 원티드 사이트에 접속하여 로그인한 뒤, '데이터 분석가' 채용 공고를 검색해 주세요. "
            "검색 결과 목록이 표시되면, '[쿠팡] 데이터 분석가' (또는 첫 번째 채용 공고)를 선택하여 상세 페이지로 이동해 주세요. "
            "상세 페이지에 진입한 후, '상세 정보 더 보기' 버튼 마커를 클릭하여 본문을 완전히 펼치고, "
            "화면을 아래로 스크롤하면서 본문 전체(주요업무, 자격요건, 우대사항, 혜택 등)를 판독해 주세요. "
            "모든 본문 요소를 판독한 뒤, 수집한 정보를 회사명, 직무명, 주요업무, 자격요건, 우대사항, 혜택 항목별로 정리하여 'finish_task'를 호출해 주세요."
        ),
        "ui_context": "",
        "action_history": [],
        "recent_images": [],
