...
def normalize_collection_steps(
    ...
    for step in plan.steps:
        ...
        normalized_intent = CollectionIntent(
            site=site,
...
def normalize_evidence_requirements(
    ...
    for requirement in plan.requirements:
        ...
        elif single_requirement and investigation.constraints.count_mode == "explicit":
...
def _validated_requirement_report(
    ...
    if requirement_count == 1 and constraints.count_mode == "explicit":
        selected_ids = matching_ids[: constraints.target_count]
    ...
    if (requirement.posted_from or requirement.posted_to) and len(
        posted_dates
