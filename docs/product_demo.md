...
승격하도록 바꾸고, 입력 대상의 1픽셀 반올림 오차도 자율탐색과 반복탐색에서
같은 기준으로 검증했습니다.

| 사이트·모드 | 실행시간 | 추론 | OCR | Reflex | 작업 목록 | 저장 |
|---|---:|---:|---:|---:|---:|---:|
| 원티드 자율 | 81.78초 | 11회 | 10회 | 0회 | 2회 | 2건 |
| 원티드 반복 | 72.27초 | 7회 | 10회 | 4회 | 2회 | 2건 |
| 사람인 자율 | 63.20초 | 8회 | 8회 | 0회 | 1회 | 1건 |
| 사람인 반복 | 47.51초 | 4회 | 6회 | 2회 | 1회 | 1건 |
| 잡코리아 자율 | 76.12초 | 12회 | 10회 | 0회 | 1회 | 1건 |
| 잡코리아 반복 | 34.52초 | 3회 | 4회 | 1회 | 1회 | 1건 |
| 고용24 자율 | 59.43초 | 8회 | 7회 | 0회 | 1회 | 1건 |
| 고용24 반복 | 64.04초 | 8회 | 8회 | 1회 | 1회 | 1건 |

모든 행은 목표 수와 DB 저장 품질을 통과했습니다. 원티드·사람인·잡코리아는
반복 실행이 빨라졌지만 고용24는 검색 입력만 재사용해 오히려 4.61초
...
|---|---|---:|---:|---:|---:|---:|---:|---:|
| 원티드 자율 | `6ae20a6` | 통과 | 74.82초 | 10회 | 9회 | 0회 | 88,196 | $0.1330 |
| 원티드 반복 | `6ae20a6` | 통과 | 61.73초 | 7회 | 9회 | 3회 | 63,700 | $0.0945 |
| 잡코리아 자율 | `98c1b93` | 통과 | 37.59초 | 5회 | 4회 | 0회 | 41,423 | $0.0605 |
| 잡코리아 반복 | `98c1b93` | 통과 | 83.93초 | 10회 | 16회 | 2회 | 84,221 | $0.1278 |

원티드는 반복탐색에서 실행시간 17.5%, 추론 30.0%, 토큰 27.8%가 줄었습니다.
자율탐색 뒤 Critic 승격에는 별도로 17.99초와 13,185토큰이 들었으므로 첫
...
정확성은 복구됐지만 잡코리아 반복탐색은 승격된 검색창 클릭을 두 번 재생한 뒤
커뮤니티 화면으로 이동했고, 자율 복구 때문에 자율탐색보다 46.35초 느렸습니다.
...
- 등록된 여러 채용사이트에서 DOM selector 없이 같은 화면 관찰·물리 입력
  런타임을 재사용할 수 있습니다.
- Reflex는 전체 자율탐색을 대체하지 않고, 화면 증거로 검증 가능한 원자 단계의
  추론만 선택적으로 생략합니다.
