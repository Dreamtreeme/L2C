...
| 시나리오 | 실행시간 | 품질 | 주요 관측 |
|---|---:|---|---|
| 원티드 자율 탐색, iOS 2건 | 63.30초 | 2건 저장, 통과 | 카드 큐 재생 1회, OCR timeout 0회 |
| 사람인 자율 탐색, 머신러닝 1건 | 39.14초 | 1건 저장, 통과 | OCR timeout 0회 |
| 로켓펀치 자율 탐색, 백엔드 1건 | 43.91초 | 1건 저장, 통과 | SPA 측면 상세 URL 증거 보완 후 재검증 |
| 고용24 자율 탐색, 데이터 분석 1건 | 37.33초 | 1건 저장, 통과 | 후보 저장 후 Critic 승격 성공 |
| 고용24 경험 기반 탐색, 동일 요청 | 43.33초 | 1건 저장, 통과 | Reflex 1회, 후속 전략 1회, 성능 비교 가능 |
