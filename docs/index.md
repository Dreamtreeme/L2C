...
| 문서 | 역할 |
|---|---|
| [`README.md`](../README.md) | 문제, 설계 판단, 대표 결과와 핵심 코드 진입점 |
| [제품 데모 가이드](product_demo.md) | 현재 UI 시연과 재현 시나리오 |
| [현재 버전 검증 기록](evidence/l2c_metrics_20260822.md) | 대표 수치의 분모, 실패와 해석 한계 |
...
| [Reflex Recipe 구현 기준](reflex_recipe_plan.md) | 현재 | 후보 저장, Critic 검토, ROI 재생 계약 |

## 현재 실행과 평가

| 문서 | 상태 | 내용 |
|---|---|---|
| [제품 데모 가이드](product_demo.md) | 현재 | 합성 DB, 질문 보완, 실제 수집과 안전 취소 시연 |
...
| 문서 | 상태 | 내용 |
|---|---|---|
| [제품 회귀 실행 기록](history/product_regression_runs.md) | 보관 | 2026-07-24~08-14의 날짜별 실행값과 재검증 |
| [개발 단계 기록](development_history.md) | 보관 | Phase별 구현 범위와 축소 과정 |
...
| [2026-08-20 정량 검증 기록](evidence/l2c_metrics_20260820.md) | 보관 | 이전 코드·표본의 측정 결과 |
